        ...
        <div className="industries-header">
          ...
          <div className="industries-header-right">
            <p className="industries-description">
              From regulated sectors to high-growth digital businesses, we tailor cybersecurity <br /> and GRC programs to how your industry operates, competes, and earns trust.
            </p>
          </div>
        </div>
